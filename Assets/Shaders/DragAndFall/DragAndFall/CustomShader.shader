...
Shader "DragAndFall/CustomShader"
{
	...
	SubShader
	{
		...
		#pragma surface surf ToonyColorsCustom vertex:vertex_surface exclude_path:deferred exclude_path:prepass keepalpha noforwardadd halfasview interpolateview nolightmap nofog nolppv
		#pragma target 2.5
		...
		void surf(Input input, inout SurfaceOutputCustom output)
		{
			...
			float3 __emission = ( _EmissionColor.rgb * tex2D(_Emission, input.texcoord0.xy * _Emission_ST.xy + _Emission_ST.zw).rrr );
